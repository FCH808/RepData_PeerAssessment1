...
# (presumably for work) and takes by far the most steps of the week on
# weekdays between 8:15am and 8:45am (maybe walking to work?).

# On the weekends, activity is more sluggish until around 8:00am, but there
# is more activity during the day on average.

# Generally, by 20:00 (8pm) most activity has stopped on weekdays, while
# weekends show surges of activity until 21:30 (9:30pm).
